...
HELP = (
    ...
    "🍽 <b>Що приготувати?</b> — оберіть кнопку («Вечеря», «Десерт», «До чаю»…) "
    "або напишіть як зручно: «що приготувати з курки?», «до чаю не солодке».\n\n"
    ...
    "📖 <b>Мої рецепти</b> — «Весь список» покаже всю базу за категоріями "
    "з наскрізними номерами. Введіть номер — покажу рецепт повністю. "
    "Знизу кнопки «🗑 Видалити» і «✏️ Редагувати»: натисніть, введіть номер — "
    "і я видалю страву або оновлю її за вашим описом.\n\n"
